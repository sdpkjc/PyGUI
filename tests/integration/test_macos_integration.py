"""Integration tests for macOS backend.

These tests require actual macOS environment and accessibility permissions.
...
# Only run these tests on macOS with integration marker
pytestmark = [
...
class TestMacOSMouseIntegration:
    """Integration tests for mouse operations on macOS."""
    ...
    def test_mouse_move_and_position(self) -> None:
        ...
        # Check new position (allow small margin for animation)
        time.sleep(0.1)
...
class TestMacOSKeyboardIntegration:
    """Integration tests for keyboard operations on macOS."""
...
class TestMacOSDisplayIntegration:
    """Integration tests for display operations on macOS."""
...
class TestMacOSWindowIntegration:
    """Integration tests for window operations on macOS."""
...
class TestMacOSClipboardIntegration:
    """Integration tests for clipboard operations on macOS."""
    ...
    def test_clipboard_unicode(self) -> None:
        """Test clipboard with Unicode."""
        from guiguigui import clipboard
    ...
    def test_clipboard_clear(self) -> None:
        ...
        # After clear, might be empty or have default content
        # Just verify clear doesn't raise exception
...
class TestMacOSEndToEnd:
    """End-to-end integration tests."""

    def test_complete_workflow(self) -> None:
        """Test a complete workflow using multiple components."""
        from guiguigui import clipboard, display, keyboard, mouse
